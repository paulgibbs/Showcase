...
class BB_Admin {
	...
	public function admin_menus() {
		...
		if ( current_user_can( 'dps_tools_page' ) ) {
			if ( current_user_can( 'dps_tools_repair_page' ) ) {
				$hooks[] = add_management_page(
					__( 'Repair Forums', 'dps' ),
					__( 'Forum Repair',  'showcase' ),
			...
			if ( current_user_can( 'dps_tools_import_page' ) ) {
				$hooks[] = add_management_page(
					__( 'Import Forums', 'dps' ),
					__( 'Forum Import',  'showcase' ),
					$this->minimum_capability,
					'bbp-converter',
			...
			// Fudge the highlighted subnav item when on a showcase admin page
		...
		if ( current_user_can( 'dps_about_page' ) ) {
			...
			// About
			add_dashboard_page(
				__( 'Welcome to showcase',  'showcase' ),
				__( 'Welcome to showcase',  'showcase' ),
				$this->minimum_capability,
				'bbp-about',
	...
	public function admin_head() {
		...
		/*<![CDATA[*/
			...
			<?php if ( 'showcase' == get_user_option( 'admin_color' ) ) : ?>
